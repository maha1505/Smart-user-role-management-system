...
const Login = () => {
    ...
    const handleLogin = (e) => {
        ...
        // Mock Login Logic for Frontend-First Phase
        setTimeout(() => {
            let role = 'employee';
            if (username.toLowerCase().includes('admin')) role = 'admin';
            else if (username.toLowerCase().includes('manager')) role = 'manager';
            else if (username.toLowerCase().includes('hr')) role = 'hr';
            else if (username.toLowerCase().includes('accountant')) role = 'accountant';
    ...
    return (
        <Container maxWidth="sm">
            <Box sx={{ mt: 10, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                {/* <Box sx={{ mt: 4, p: 2, bgcolor: 'info.light', borderRadius: 2, width: '100%' }}>
                    <Typography variant="caption" color="info.contrastText" fontWeight="bold">
                        💡 PRO TIP: For testing mock roles, use usernames containing 'admin', 'manager', 'hr', or 'accountant'.
                    </Typography>
                </Box> */}
            </Box>
        </Container>
